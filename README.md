...
| 月遅れ請求 | 元の請求対象月と金額を明細ごとに登録し、当月分と分けて加算 |
...
月遅れ分は「月遅れ請求」に元月と金額を登録します。複数月分の明細も登録できます。
当月分が「当月停止」でも、月遅れ請求額だけを e集ちゃんの入力・照合対象にできます。
現金支払いは、当月額・合算分・月遅れ分を現金請求合計に含めますが、e集ちゃんの入力・照合対象には含めません。
